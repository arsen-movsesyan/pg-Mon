...
--
-- Name: pgMon; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "pgMon" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C' LC_CTYPE = 'C';


ALTER DATABASE "pgMon" OWNER TO postgres;
...
ALTER TABLE bgwriter_stat ALTER COLUMN id SET DEFAULT nextval('bgwriter_stat_id_seq'::regclass);
...
ALTER TABLE database_stat ALTER COLUMN id SET DEFAULT nextval('database_stat_id_seq'::regclass);
...
ALTER TABLE function_stat ALTER COLUMN id SET DEFAULT nextval('function_stat_id_seq'::regclass);
...
ALTER TABLE index_stat ALTER COLUMN id SET DEFAULT nextval('index_stat_id_seq'::regclass);
...
ALTER TABLE index_toast_stat ALTER COLUMN id SET DEFAULT nextval('index_toast_stat_id_seq'::regclass);
...
ALTER TABLE table_stat ALTER COLUMN id SET DEFAULT nextval('table_stat_id_seq'::regclass);
...
ALTER TABLE table_toast_stat ALTER COLUMN id SET DEFAULT nextval('table_toast_stat_id_seq'::regclass);
...
ALTER TABLE table_va_stat ALTER COLUMN id SET DEFAULT nextval('table_va_stat_id_seq'::regclass);
