...
--
-- Name: db_mon; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE db_mon WITH TEMPLATE = template0 ENCODING = 'SQL_ASCII' LC_COLLATE = 'C' LC_CTYPE = 'C';


ALTER DATABASE db_mon OWNER TO postgres;
...
--
-- Name: ENUM_track_functions; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE "ENUM_track_functions" AS ENUM (
    'none',
    'pl',
    'all'
);
...
ALTER TYPE public."ENUM_track_functions" OWNER TO postgres;
...
--
-- Name: trigger_add_log_time(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION trigger_add_log_time() RETURNS trigger
    LANGUAGE plpgsql
    AS $$BEGIN
	INSERT INTO queue_log_time (id,hour_truncate) VALUES (NEW.id,NEW.hour_truncate);
	RETURN NEW;
END$$;


ALTER FUNCTION public.trigger_add_log_time() OWNER TO postgres;
...
CREATE TABLE host_cluster (
    ...
    track_functions "ENUM_track_functions" DEFAULT 'none'::"ENUM_track_functions" NOT NULL
);
...
--
-- Name: queue_log_time; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE queue_log_time (
    id integer NOT NULL,
    hour_truncate timestamp without time zone NOT NULL
);


ALTER TABLE public.queue_log_time OWNER TO postgres;
...
--
-- Name: queue_log_time_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY queue_log_time
    ADD CONSTRAINT queue_log_time_pkey PRIMARY KEY (id);
...
--
-- Name: trigger_add_log_time; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_add_log_time AFTER INSERT ON log_time FOR EACH ROW EXECUTE PROCEDURE trigger_add_log_time();
...
--
-- Name: queue_log_time_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY queue_log_time
    ADD CONSTRAINT queue_log_time_id_fkey FOREIGN KEY (id) REFERENCES log_time(id);
